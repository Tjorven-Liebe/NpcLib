...
public class MineskinClient {
    ...
    public CompletableFuture<MineSkin> getId(long id) {
    ...
    public CompletableFuture<MineSkin> getUuid(UUID uuid) {
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    public CompletableFuture<MineSkin> generateUrl(String url) {
     ...
     */
    public CompletableFuture<MineSkin> generateUrl(String url, SkinOptions options) {
        checkNotNull(url);
    ...
    public CompletableFuture<MineSkin> generateUpload(InputStream is) {
        return generateUpload(is, SkinOptions.none(), null);
    }

    public CompletableFuture<MineSkin> generateUpload(InputStream is, SkinOptions options) {
        return generateUpload(is, options, options.getName() + ".png");
    }

    public CompletableFuture<MineSkin> generateUpload(InputStream is, String name) {
        return generateUpload(is, SkinOptions.none(), name);
    }

    public CompletableFuture<MineSkin> generateUpload(InputStream is, SkinOptions options, String name) {
        checkNotNull(is);
        checkNotNull(options);
        return CompletableFuture.supplyAsync(() -> {
            try {
     ...
     */
    public CompletableFuture<MineSkin> generateUpload(File file) throws FileNotFoundException {
        return generateUpload(file, SkinOptions.none());
    }

    public CompletableFuture<MineSkin> generateUpload(File file, SkinOptions options) throws FileNotFoundException {
        checkNotNull(file);
        checkNotNull(options);
     ...
     */
    public CompletableFuture<MineSkin> generateUpload(RenderedImage image) throws IOException {
        return generateUpload(image, SkinOptions.none());
    }

    public CompletableFuture<MineSkin> generateUpload(RenderedImage image, SkinOptions options) throws IOException {
        checkNotNull(image);
        checkNotNull(options);
    ...
    public CompletableFuture<MineSkin> generateUser(UUID uuid) {
     ...
     */
    public CompletableFuture<MineSkin> generateUser(UUID uuid, SkinOptions options) {
        checkNotNull(uuid);
        checkNotNull(options);
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    MineSkin handleResponse(String body) throws MineskinException, JsonParseException {
        JsonObject jsonObject = gson.fromJson(body, JsonObject.class);
        if (jsonObject.has("error")) {
            throw new MineskinException(jsonObject.get("error").getAsString());
        }

        MineSkin skin = gson.fromJson(jsonObject, MineSkin.class);
    ...
    /**
     * Gets data for an existing MineSkin
     *
